...
class Robokassa:
    ...
    def gen_payment_data(
        self, user_id: int | str, inv_id: int, price: int, tariff_desc: str, recurring: bool, mother_inv_id: int = None
    ) -> dict:
    ...
    def gen_pay_url(self, user_id: int, inv_id: int, price: int, tariff_desc: str, recurring: bool = True) -> str:
